classdef ReduceMeanLayer1011 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2b.coder.ReduceMeanLayer1011(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2b.ReduceMeanLayer1011(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_block_165] = predict(this, x_backbone_block_159__)
            ...
            x_backbone_block_159 = branchA_v2b.coder.ops.permuteInputVar(x_backbone_block_159_, [4 3 1 2], 4);
            ...
            x_backbone_block_165_ = branchA_v2b.coder.ops.permuteOutputVar(x_backbone_block_165__, [3 4 2 1], 4);
        ...
        function [x_backbone_block_165, x_backbone_block_165NumDims1035] = ReduceMeanGraph1033(this, x_backbone_block_159, x_backbone_block_159NumDims, Training)
            ...
            % ReduceMean:
            dims1022 = branchA_v2b.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1034, coder.const(x_backbone_block_159NumDims));
