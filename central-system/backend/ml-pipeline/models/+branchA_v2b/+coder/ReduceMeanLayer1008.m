classdef ReduceMeanLayer1008 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2b.coder.ReduceMeanLayer1008(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2b.ReduceMeanLayer1008(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_block_121] = predict(this, x_backbone_block_115__)
            ...
            x_backbone_block_115 = branchA_v2b.coder.ops.permuteInputVar(x_backbone_block_115_, [4 3 1 2], 4);
            ...
            x_backbone_block_121_ = branchA_v2b.coder.ops.permuteOutputVar(x_backbone_block_121__, [3 4 2 1], 4);
        ...
        function [x_backbone_block_121, x_backbone_block_121NumDims1026] = ReduceMeanGraph1024(this, x_backbone_block_115, x_backbone_block_115NumDims, Training)
            ...
            % ReduceMean:
            dims1016 = branchA_v2b.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1025, coder.const(x_backbone_block_115NumDims));
