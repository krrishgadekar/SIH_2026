classdef ReduceMeanLayer1000 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2b.coder.ReduceMeanLayer1000';
        end
    end
    ...
    methods
        ...
        function [x_backbone_blocks__5] = predict(this, x_backbone_blocks_bl)
            ...
            x_backbone_blocks_bl = branchA_v2b.ops.permuteInputVar(x_backbone_blocks_bl, [4 3 1 2], 4);
            ...
            x_backbone_blocks__5 = branchA_v2b.ops.permuteOutputVar(x_backbone_blocks__5, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks__5, x_backbone_blocks__5NumDims1002] = ReduceMeanGraph1000(this, x_backbone_blocks_bl, x_backbone_blocks_blNumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2b.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1001, x_backbone_blocks_blNumDims);
