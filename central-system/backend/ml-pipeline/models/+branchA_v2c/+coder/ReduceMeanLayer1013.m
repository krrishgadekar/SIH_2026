classdef ReduceMeanLayer1013 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2c.coder.ReduceMeanLayer1013(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2c.ReduceMeanLayer1013(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_block_195] = predict(this, x_backbone_block_189__)
            ...
            x_backbone_block_189 = branchA_v2c.coder.ops.permuteInputVar(x_backbone_block_189_, [4 3 1 2], 4);
            ...
            x_backbone_block_195_ = branchA_v2c.coder.ops.permuteOutputVar(x_backbone_block_195__, [3 4 2 1], 4);
        ...
        function [x_backbone_block_195, x_backbone_block_195NumDims1041] = ReduceMeanGraph1039(this, x_backbone_block_189, x_backbone_block_189NumDims, Training)
            ...
            % ReduceMean:
            dims1026 = branchA_v2c.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1040, coder.const(x_backbone_block_189NumDims));
