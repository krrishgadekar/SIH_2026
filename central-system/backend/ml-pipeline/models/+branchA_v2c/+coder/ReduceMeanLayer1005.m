classdef ReduceMeanLayer1005 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2c.coder.ReduceMeanLayer1005(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2c.ReduceMeanLayer1005(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_blocks_77] = predict(this, x_backbone_blocks_71__)
            ...
            x_backbone_blocks_71 = branchA_v2c.coder.ops.permuteInputVar(x_backbone_blocks_71_, [4 3 1 2], 4);
            ...
            x_backbone_blocks_77_ = branchA_v2c.coder.ops.permuteOutputVar(x_backbone_blocks_77__, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_77, x_backbone_blocks_77NumDims1017] = ReduceMeanGraph1015(this, x_backbone_blocks_71, x_backbone_blocks_71NumDims, Training)
            ...
            % ReduceMean:
            dims1010 = branchA_v2c.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1016, coder.const(x_backbone_blocks_71NumDims));
