classdef ReduceMeanLayer1015 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2c.coder.ReduceMeanLayer1015(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2c.ReduceMeanLayer1015(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_block_224] = predict(this, x_backbone_block_218__)
            ...
            x_backbone_block_218 = branchA_v2c.coder.ops.permuteInputVar(x_backbone_block_218_, [4 3 1 2], 4);
            ...
            x_backbone_block_224_ = branchA_v2c.coder.ops.permuteOutputVar(x_backbone_block_224__, [3 4 2 1], 4);
        ...
        function [x_backbone_block_224, x_backbone_block_224NumDims1047] = ReduceMeanGraph1045(this, x_backbone_block_218, x_backbone_block_218NumDims, Training)
            ...
            % ReduceMean:
            dims1030 = branchA_v2c.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1046, coder.const(x_backbone_block_218NumDims));
