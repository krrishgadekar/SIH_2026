classdef ReduceMeanLayer1004 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2c.coder.ReduceMeanLayer1004(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2c.ReduceMeanLayer1004(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_blocks_63] = predict(this, x_backbone_blocks_57__)
            ...
            x_backbone_blocks_57 = branchA_v2c.coder.ops.permuteInputVar(x_backbone_blocks_57_, [4 3 1 2], 4);
            ...
            x_backbone_blocks_63_ = branchA_v2c.coder.ops.permuteOutputVar(x_backbone_blocks_63__, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_63, x_backbone_blocks_63NumDims1014] = ReduceMeanGraph1012(this, x_backbone_blocks_57, x_backbone_blocks_57NumDims, Training)
            ...
            % ReduceMean:
            dims1008 = branchA_v2c.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1013, coder.const(x_backbone_blocks_57NumDims));
