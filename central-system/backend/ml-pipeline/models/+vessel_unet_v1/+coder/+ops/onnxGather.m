...
% Copyright 2024 The MathWorks, Inc.
    ...
    X          = vessel_unet_v1.coder.ops.extractIfDlarray(X_);
    ONNXIdx    = vessel_unet_v1.coder.ops.extractIfDlarray(ONNXIdx_);
    ONNXAxis   = vessel_unet_v1.coder.ops.extractIfDlarray(ONNXAxis_);
    numDimsX   = vessel_unet_v1.coder.ops.extractIfDlarray(numDimsX_);
    numDimsIdx = vessel_unet_v1.coder.ops.extractIfDlarray(numDimsIdx_);
