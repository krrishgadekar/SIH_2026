...
%   Copyright 2024-2025 The MathWorks, Inc.  
    ...
    ONNXScales                        = vessel_unet_v1.coder.ops.extractIfDlarray(ONNXScales_);
    ONNXSizes                         = vessel_unet_v1.coder.ops.extractIfDlarray(ONNXSizes_);
    coordinate_transformation_mode    = vessel_unet_v1.coder.ops.extractIfDlarray(coordinate_transformation_mode_);
    mode                              = vessel_unet_v1.coder.ops.extractIfDlarray(mode_);
    nearest_mode                      = vessel_unet_v1.coder.ops.extractIfDlarray(nearest_mode_);
    numDimsX                          = vessel_unet_v1.coder.ops.extractIfDlarray(numDimsX_);
