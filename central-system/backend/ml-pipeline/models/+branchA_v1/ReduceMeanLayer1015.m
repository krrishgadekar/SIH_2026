classdef ReduceMeanLayer1015 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v1.coder.ReduceMeanLayer1015';
        end
    end
    ...
    methods
        ...
        function [x_backbone_block_224] = predict(this, x_backbone_block_218)
            ...
            x_backbone_block_218 = branchA_v1.ops.permuteInputVar(x_backbone_block_218, [4 3 1 2], 4);
            ...
            x_backbone_block_224 = branchA_v1.ops.permuteOutputVar(x_backbone_block_224, [3 4 2 1], 4);
        ...
        function [x_backbone_block_224, x_backbone_block_224NumDims1047] = ReduceMeanGraph1045(this, x_backbone_block_218, x_backbone_block_218NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v1.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1046, x_backbone_block_218NumDims);
