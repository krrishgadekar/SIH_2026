classdef ReduceMeanLayer1014 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v1.coder.ReduceMeanLayer1014';
        end
    end
    ...
    methods
        ...
        function [x_backbone_block_210] = predict(this, x_backbone_block_204)
            ...
            x_backbone_block_204 = branchA_v1.ops.permuteInputVar(x_backbone_block_204, [4 3 1 2], 4);
            ...
            x_backbone_block_210 = branchA_v1.ops.permuteOutputVar(x_backbone_block_210, [3 4 2 1], 4);
        ...
        function [x_backbone_block_210, x_backbone_block_210NumDims1044] = ReduceMeanGraph1042(this, x_backbone_block_204, x_backbone_block_204NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v1.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1043, x_backbone_block_204NumDims);
