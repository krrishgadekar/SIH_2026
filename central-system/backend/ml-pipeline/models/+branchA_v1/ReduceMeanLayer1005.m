classdef ReduceMeanLayer1005 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v1.coder.ReduceMeanLayer1005';
        end
    end
    ...
    methods
        ...
        function [x_backbone_blocks_77] = predict(this, x_backbone_blocks_71)
            ...
            x_backbone_blocks_71 = branchA_v1.ops.permuteInputVar(x_backbone_blocks_71, [4 3 1 2], 4);
            ...
            x_backbone_blocks_77 = branchA_v1.ops.permuteOutputVar(x_backbone_blocks_77, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_77, x_backbone_blocks_77NumDims1017] = ReduceMeanGraph1015(this, x_backbone_blocks_71, x_backbone_blocks_71NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v1.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1016, x_backbone_blocks_71NumDims);
