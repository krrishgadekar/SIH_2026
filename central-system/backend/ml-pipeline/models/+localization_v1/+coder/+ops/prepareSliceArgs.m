...
Starts = localization_v1.coder.ops.extractIfDlarray(Starts_);
Ends = localization_v1.coder.ops.extractIfDlarray(Ends_);
Axes_ = localization_v1.coder.ops.extractIfDlarray(Axes__);
Steps_ = localization_v1.coder.ops.extractIfDlarray(Steps__);
