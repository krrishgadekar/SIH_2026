...
Starts = bright_lesion_unet_v1.coder.ops.extractIfDlarray(Starts_);
Ends = bright_lesion_unet_v1.coder.ops.extractIfDlarray(Ends_);
Axes_ = bright_lesion_unet_v1.coder.ops.extractIfDlarray(Axes__);
Steps_ = bright_lesion_unet_v1.coder.ops.extractIfDlarray(Steps__);
