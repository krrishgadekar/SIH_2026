...
% Copyright 2024 The MathWorks, Inc.
    ...
    X          = bright_lesion_unet_v1.coder.ops.extractIfDlarray(X_);
    ONNXIdx    = bright_lesion_unet_v1.coder.ops.extractIfDlarray(ONNXIdx_);
    ONNXAxis   = bright_lesion_unet_v1.coder.ops.extractIfDlarray(ONNXAxis_);
    numDimsX   = bright_lesion_unet_v1.coder.ops.extractIfDlarray(numDimsX_);
    numDimsIdx = bright_lesion_unet_v1.coder.ops.extractIfDlarray(numDimsIdx_);
