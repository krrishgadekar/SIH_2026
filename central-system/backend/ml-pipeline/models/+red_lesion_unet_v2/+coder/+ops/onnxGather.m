...
% Copyright 2024 The MathWorks, Inc.
    ...
    X          = red_lesion_unet_v2.coder.ops.extractIfDlarray(X_);
    ONNXIdx    = red_lesion_unet_v2.coder.ops.extractIfDlarray(ONNXIdx_);
    ONNXAxis   = red_lesion_unet_v2.coder.ops.extractIfDlarray(ONNXAxis_);
    numDimsX   = red_lesion_unet_v2.coder.ops.extractIfDlarray(numDimsX_);
    numDimsIdx = red_lesion_unet_v2.coder.ops.extractIfDlarray(numDimsIdx_);
