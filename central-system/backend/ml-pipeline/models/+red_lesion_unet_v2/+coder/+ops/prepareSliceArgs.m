...
Starts = red_lesion_unet_v2.coder.ops.extractIfDlarray(Starts_);
Ends = red_lesion_unet_v2.coder.ops.extractIfDlarray(Ends_);
Axes_ = red_lesion_unet_v2.coder.ops.extractIfDlarray(Axes__);
Steps_ = red_lesion_unet_v2.coder.ops.extractIfDlarray(Steps__);
