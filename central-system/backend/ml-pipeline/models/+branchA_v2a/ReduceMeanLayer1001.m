classdef ReduceMeanLayer1001 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2a.coder.ReduceMeanLayer1001';
        end
    end
    ...
    methods
        ...
        function [x_backbone_blocks_19] = predict(this, x_backbone_blocks_13)
            ...
            x_backbone_blocks_13 = branchA_v2a.ops.permuteInputVar(x_backbone_blocks_13, [4 3 1 2], 4);
            ...
            x_backbone_blocks_19 = branchA_v2a.ops.permuteOutputVar(x_backbone_blocks_19, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_19, x_backbone_blocks_19NumDims1005] = ReduceMeanGraph1003(this, x_backbone_blocks_13, x_backbone_blocks_13NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2a.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1004, x_backbone_blocks_13NumDims);
