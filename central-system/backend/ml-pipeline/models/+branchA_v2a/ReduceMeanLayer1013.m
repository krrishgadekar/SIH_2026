classdef ReduceMeanLayer1013 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2a.coder.ReduceMeanLayer1013';
        end
    end
    ...
    methods
        ...
        function [x_backbone_block_195] = predict(this, x_backbone_block_189)
            ...
            x_backbone_block_189 = branchA_v2a.ops.permuteInputVar(x_backbone_block_189, [4 3 1 2], 4);
            ...
            x_backbone_block_195 = branchA_v2a.ops.permuteOutputVar(x_backbone_block_195, [3 4 2 1], 4);
        ...
        function [x_backbone_block_195, x_backbone_block_195NumDims1041] = ReduceMeanGraph1039(this, x_backbone_block_189, x_backbone_block_189NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2a.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1040, x_backbone_block_189NumDims);
