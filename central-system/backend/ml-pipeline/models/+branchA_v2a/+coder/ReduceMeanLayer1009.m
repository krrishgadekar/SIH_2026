classdef ReduceMeanLayer1009 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2a.coder.ReduceMeanLayer1009(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2a.ReduceMeanLayer1009(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_block_136] = predict(this, x_backbone_block_130__)
            ...
            x_backbone_block_130 = branchA_v2a.coder.ops.permuteInputVar(x_backbone_block_130_, [4 3 1 2], 4);
            ...
            x_backbone_block_136_ = branchA_v2a.coder.ops.permuteOutputVar(x_backbone_block_136__, [3 4 2 1], 4);
        ...
        function [x_backbone_block_136, x_backbone_block_136NumDims1029] = ReduceMeanGraph1027(this, x_backbone_block_130, x_backbone_block_130NumDims, Training)
            ...
            % ReduceMean:
            dims1018 = branchA_v2a.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1028, coder.const(x_backbone_block_130NumDims));
