classdef ReduceMeanLayer1003 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2a.coder.ReduceMeanLayer1003(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2a.ReduceMeanLayer1003(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_blocks_48] = predict(this, x_backbone_blocks_42__)
            ...
            x_backbone_blocks_42 = branchA_v2a.coder.ops.permuteInputVar(x_backbone_blocks_42_, [4 3 1 2], 4);
            ...
            x_backbone_blocks_48_ = branchA_v2a.coder.ops.permuteOutputVar(x_backbone_blocks_48__, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_48, x_backbone_blocks_48NumDims1011] = ReduceMeanGraph1009(this, x_backbone_blocks_42, x_backbone_blocks_42NumDims, Training)
            ...
            % ReduceMean:
            dims1006 = branchA_v2a.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1010, coder.const(x_backbone_blocks_42NumDims));
