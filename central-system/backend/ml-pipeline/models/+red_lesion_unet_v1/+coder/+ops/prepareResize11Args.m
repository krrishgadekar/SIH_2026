...
%   Copyright 2024-2025 The MathWorks, Inc.  
    ...
    ONNXScales                        = red_lesion_unet_v1.coder.ops.extractIfDlarray(ONNXScales_);
    ONNXSizes                         = red_lesion_unet_v1.coder.ops.extractIfDlarray(ONNXSizes_);
    coordinate_transformation_mode    = red_lesion_unet_v1.coder.ops.extractIfDlarray(coordinate_transformation_mode_);
    mode                              = red_lesion_unet_v1.coder.ops.extractIfDlarray(mode_);
    nearest_mode                      = red_lesion_unet_v1.coder.ops.extractIfDlarray(nearest_mode_);
    numDimsX                          = red_lesion_unet_v1.coder.ops.extractIfDlarray(numDimsX_);
