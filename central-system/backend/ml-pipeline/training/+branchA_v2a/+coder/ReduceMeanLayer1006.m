classdef ReduceMeanLayer1006 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2a.coder.ReduceMeanLayer1006(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2a.ReduceMeanLayer1006(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_blocks_92] = predict(this, x_backbone_blocks_86__)
            ...
            x_backbone_blocks_86 = branchA_v2a.coder.ops.permuteInputVar(x_backbone_blocks_86_, [4 3 1 2], 4);
            ...
            x_backbone_blocks_92_ = branchA_v2a.coder.ops.permuteOutputVar(x_backbone_blocks_92__, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_92, x_backbone_blocks_92NumDims1020] = ReduceMeanGraph1018(this, x_backbone_blocks_86, x_backbone_blocks_86NumDims, Training)
            ...
            % ReduceMean:
            dims1012 = branchA_v2a.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1019, coder.const(x_backbone_blocks_86NumDims));
