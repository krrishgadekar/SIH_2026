classdef ReduceMeanLayer1012 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2a.coder.ReduceMeanLayer1012(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2a.ReduceMeanLayer1012(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_block_180] = predict(this, x_backbone_block_174__)
            ...
            x_backbone_block_174 = branchA_v2a.coder.ops.permuteInputVar(x_backbone_block_174_, [4 3 1 2], 4);
            ...
            x_backbone_block_180_ = branchA_v2a.coder.ops.permuteOutputVar(x_backbone_block_180__, [3 4 2 1], 4);
        ...
        function [x_backbone_block_180, x_backbone_block_180NumDims1038] = ReduceMeanGraph1036(this, x_backbone_block_174, x_backbone_block_174NumDims, Training)
            ...
            % ReduceMean:
            dims1024 = branchA_v2a.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1037, coder.const(x_backbone_block_174NumDims));
