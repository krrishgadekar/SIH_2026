classdef ReduceMeanLayer1008 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v1.coder.ReduceMeanLayer1008';
        end
    end
    ...
    methods
        ...
        function [x_backbone_block_121] = predict(this, x_backbone_block_115)
            ...
            x_backbone_block_115 = branchA_v1.ops.permuteInputVar(x_backbone_block_115, [4 3 1 2], 4);
            ...
            x_backbone_block_121 = branchA_v1.ops.permuteOutputVar(x_backbone_block_121, [3 4 2 1], 4);
        ...
        function [x_backbone_block_121, x_backbone_block_121NumDims1026] = ReduceMeanGraph1024(this, x_backbone_block_115, x_backbone_block_115NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v1.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1025, x_backbone_block_115NumDims);
