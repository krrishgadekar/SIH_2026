classdef ReduceMeanLayer1011 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v1.coder.ReduceMeanLayer1011';
        end
    end
    ...
    methods
        ...
        function [x_backbone_block_165] = predict(this, x_backbone_block_159)
            ...
            x_backbone_block_159 = branchA_v1.ops.permuteInputVar(x_backbone_block_159, [4 3 1 2], 4);
            ...
            x_backbone_block_165 = branchA_v1.ops.permuteOutputVar(x_backbone_block_165, [3 4 2 1], 4);
        ...
        function [x_backbone_block_165, x_backbone_block_165NumDims1035] = ReduceMeanGraph1033(this, x_backbone_block_159, x_backbone_block_159NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v1.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1034, x_backbone_block_159NumDims);
