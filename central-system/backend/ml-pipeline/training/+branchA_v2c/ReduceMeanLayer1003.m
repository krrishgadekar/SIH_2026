classdef ReduceMeanLayer1003 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2c.coder.ReduceMeanLayer1003';
        end
    end
    ...
    methods
        ...
        function [x_backbone_blocks_48] = predict(this, x_backbone_blocks_42)
            ...
            x_backbone_blocks_42 = branchA_v2c.ops.permuteInputVar(x_backbone_blocks_42, [4 3 1 2], 4);
            ...
            x_backbone_blocks_48 = branchA_v2c.ops.permuteOutputVar(x_backbone_blocks_48, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_48, x_backbone_blocks_48NumDims1011] = ReduceMeanGraph1009(this, x_backbone_blocks_42, x_backbone_blocks_42NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2c.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1010, x_backbone_blocks_42NumDims);
