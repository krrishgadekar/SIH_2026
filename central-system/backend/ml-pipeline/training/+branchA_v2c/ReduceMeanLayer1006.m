classdef ReduceMeanLayer1006 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2c.coder.ReduceMeanLayer1006';
        end
    end
    ...
    methods
        ...
        function [x_backbone_blocks_92] = predict(this, x_backbone_blocks_86)
            ...
            x_backbone_blocks_86 = branchA_v2c.ops.permuteInputVar(x_backbone_blocks_86, [4 3 1 2], 4);
            ...
            x_backbone_blocks_92 = branchA_v2c.ops.permuteOutputVar(x_backbone_blocks_92, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_92, x_backbone_blocks_92NumDims1020] = ReduceMeanGraph1018(this, x_backbone_blocks_86, x_backbone_blocks_86NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2c.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1019, x_backbone_blocks_86NumDims);
