classdef ReduceMeanLayer1002 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2c.coder.ReduceMeanLayer1002(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2c.ReduceMeanLayer1002(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_blocks_34] = predict(this, x_backbone_blocks_28__)
            ...
            x_backbone_blocks_28 = branchA_v2c.coder.ops.permuteInputVar(x_backbone_blocks_28_, [4 3 1 2], 4);
            ...
            x_backbone_blocks_34_ = branchA_v2c.coder.ops.permuteOutputVar(x_backbone_blocks_34__, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_34, x_backbone_blocks_34NumDims1008] = ReduceMeanGraph1006(this, x_backbone_blocks_28, x_backbone_blocks_28NumDims, Training)
            ...
            % ReduceMean:
            dims1004 = branchA_v2c.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1007, coder.const(x_backbone_blocks_28NumDims));
