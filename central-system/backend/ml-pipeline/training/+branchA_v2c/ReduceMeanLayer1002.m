classdef ReduceMeanLayer1002 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2c.coder.ReduceMeanLayer1002';
        end
    end
    ...
    methods
        ...
        function [x_backbone_blocks_34] = predict(this, x_backbone_blocks_28)
            ...
            x_backbone_blocks_28 = branchA_v2c.ops.permuteInputVar(x_backbone_blocks_28, [4 3 1 2], 4);
            ...
            x_backbone_blocks_34 = branchA_v2c.ops.permuteOutputVar(x_backbone_blocks_34, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_34, x_backbone_blocks_34NumDims1008] = ReduceMeanGraph1006(this, x_backbone_blocks_28, x_backbone_blocks_28NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2c.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1007, x_backbone_blocks_28NumDims);
