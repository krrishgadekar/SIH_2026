classdef ReduceMeanLayer1004 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2c.coder.ReduceMeanLayer1004';
        end
    end
    ...
    methods
        ...
        function [x_backbone_blocks_63] = predict(this, x_backbone_blocks_57)
            ...
            x_backbone_blocks_57 = branchA_v2c.ops.permuteInputVar(x_backbone_blocks_57, [4 3 1 2], 4);
            ...
            x_backbone_blocks_63 = branchA_v2c.ops.permuteOutputVar(x_backbone_blocks_63, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_63, x_backbone_blocks_63NumDims1014] = ReduceMeanGraph1012(this, x_backbone_blocks_57, x_backbone_blocks_57NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2c.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1013, x_backbone_blocks_57NumDims);
