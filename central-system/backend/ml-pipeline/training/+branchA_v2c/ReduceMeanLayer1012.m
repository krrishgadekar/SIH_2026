classdef ReduceMeanLayer1012 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2c.coder.ReduceMeanLayer1012';
        end
    end
    ...
    methods
        ...
        function [x_backbone_block_180] = predict(this, x_backbone_block_174)
            ...
            x_backbone_block_174 = branchA_v2c.ops.permuteInputVar(x_backbone_block_174, [4 3 1 2], 4);
            ...
            x_backbone_block_180 = branchA_v2c.ops.permuteOutputVar(x_backbone_block_180, [3 4 2 1], 4);
        ...
        function [x_backbone_block_180, x_backbone_block_180NumDims1038] = ReduceMeanGraph1036(this, x_backbone_block_174, x_backbone_block_174NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2c.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1037, x_backbone_block_174NumDims);
