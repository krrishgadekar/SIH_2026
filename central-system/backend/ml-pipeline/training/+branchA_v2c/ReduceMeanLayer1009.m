classdef ReduceMeanLayer1009 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2c.coder.ReduceMeanLayer1009';
        end
    end
    ...
    methods
        ...
        function [x_backbone_block_136] = predict(this, x_backbone_block_130)
            ...
            x_backbone_block_130 = branchA_v2c.ops.permuteInputVar(x_backbone_block_130, [4 3 1 2], 4);
            ...
            x_backbone_block_136 = branchA_v2c.ops.permuteOutputVar(x_backbone_block_136, [3 4 2 1], 4);
        ...
        function [x_backbone_block_136, x_backbone_block_136NumDims1029] = ReduceMeanGraph1027(this, x_backbone_block_130, x_backbone_block_130NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2c.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1028, x_backbone_block_130NumDims);
