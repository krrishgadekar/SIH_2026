classdef ReduceMeanLayer1010 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2b.coder.ReduceMeanLayer1010';
        end
    end
    ...
    methods
        ...
        function [x_backbone_block_151] = predict(this, x_backbone_block_145)
            ...
            x_backbone_block_145 = branchA_v2b.ops.permuteInputVar(x_backbone_block_145, [4 3 1 2], 4);
            ...
            x_backbone_block_151 = branchA_v2b.ops.permuteOutputVar(x_backbone_block_151, [3 4 2 1], 4);
        ...
        function [x_backbone_block_151, x_backbone_block_151NumDims1032] = ReduceMeanGraph1030(this, x_backbone_block_145, x_backbone_block_145NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2b.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1031, x_backbone_block_145NumDims);
