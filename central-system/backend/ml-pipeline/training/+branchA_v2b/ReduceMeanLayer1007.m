classdef ReduceMeanLayer1007 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'branchA_v2b.coder.ReduceMeanLayer1007';
        end
    end
    ...
    methods
        ...
        function [x_backbone_block_107] = predict(this, x_backbone_block_101)
            ...
            x_backbone_block_101 = branchA_v2b.ops.permuteInputVar(x_backbone_block_101, [4 3 1 2], 4);
            ...
            x_backbone_block_107 = branchA_v2b.ops.permuteOutputVar(x_backbone_block_107, [3 4 2 1], 4);
        ...
        function [x_backbone_block_107, x_backbone_block_107NumDims1023] = ReduceMeanGraph1021(this, x_backbone_block_101, x_backbone_block_101NumDims, Training)
            ...
            % ReduceMean:
            dims = branchA_v2b.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1022, x_backbone_block_101NumDims);
