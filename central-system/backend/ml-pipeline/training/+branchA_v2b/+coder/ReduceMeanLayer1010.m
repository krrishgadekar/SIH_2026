classdef ReduceMeanLayer1010 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2b.coder.ReduceMeanLayer1010(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2b.ReduceMeanLayer1010(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_block_151] = predict(this, x_backbone_block_145__)
            ...
            x_backbone_block_145 = branchA_v2b.coder.ops.permuteInputVar(x_backbone_block_145_, [4 3 1 2], 4);
            ...
            x_backbone_block_151_ = branchA_v2b.coder.ops.permuteOutputVar(x_backbone_block_151__, [3 4 2 1], 4);
        ...
        function [x_backbone_block_151, x_backbone_block_151NumDims1032] = ReduceMeanGraph1030(this, x_backbone_block_145, x_backbone_block_145NumDims, Training)
            ...
            % ReduceMean:
            dims1020 = branchA_v2b.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1031, coder.const(x_backbone_block_145NumDims));
