classdef ReduceMeanLayer1007 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2b.coder.ReduceMeanLayer1007(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2b.ReduceMeanLayer1007(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_block_107] = predict(this, x_backbone_block_101__)
            ...
            x_backbone_block_101 = branchA_v2b.coder.ops.permuteInputVar(x_backbone_block_101_, [4 3 1 2], 4);
            ...
            x_backbone_block_107_ = branchA_v2b.coder.ops.permuteOutputVar(x_backbone_block_107__, [3 4 2 1], 4);
        ...
        function [x_backbone_block_107, x_backbone_block_107NumDims1023] = ReduceMeanGraph1021(this, x_backbone_block_101, x_backbone_block_101NumDims, Training)
            ...
            % ReduceMean:
            dims1014 = branchA_v2b.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1022, coder.const(x_backbone_block_101NumDims));
