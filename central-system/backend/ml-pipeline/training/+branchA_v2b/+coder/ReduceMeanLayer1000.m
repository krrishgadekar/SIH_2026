classdef ReduceMeanLayer1000 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2b.coder.ReduceMeanLayer1000(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2b.ReduceMeanLayer1000(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_blocks__5] = predict(this, x_backbone_blocks_bl__)
            ...
            x_backbone_blocks_bl = branchA_v2b.coder.ops.permuteInputVar(x_backbone_blocks_bl_, [4 3 1 2], 4);
            ...
            x_backbone_blocks__5_ = branchA_v2b.coder.ops.permuteOutputVar(x_backbone_blocks__5__, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks__5, x_backbone_blocks__5NumDims1002] = ReduceMeanGraph1000(this, x_backbone_blocks_bl, x_backbone_blocks_blNumDims, Training)
            ...
            % ReduceMean:
            dims1000 = branchA_v2b.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1001, coder.const(x_backbone_blocks_blNumDims));
