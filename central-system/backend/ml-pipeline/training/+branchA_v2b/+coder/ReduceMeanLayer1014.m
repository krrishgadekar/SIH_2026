classdef ReduceMeanLayer1014 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2b.coder.ReduceMeanLayer1014(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2b.ReduceMeanLayer1014(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_block_210] = predict(this, x_backbone_block_204__)
            ...
            x_backbone_block_204 = branchA_v2b.coder.ops.permuteInputVar(x_backbone_block_204_, [4 3 1 2], 4);
            ...
            x_backbone_block_210_ = branchA_v2b.coder.ops.permuteOutputVar(x_backbone_block_210__, [3 4 2 1], 4);
        ...
        function [x_backbone_block_210, x_backbone_block_210NumDims1044] = ReduceMeanGraph1042(this, x_backbone_block_204, x_backbone_block_204NumDims, Training)
            ...
            % ReduceMean:
            dims1028 = branchA_v2b.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1043, coder.const(x_backbone_block_204NumDims));
