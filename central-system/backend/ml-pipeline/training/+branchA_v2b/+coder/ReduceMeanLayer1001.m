classdef ReduceMeanLayer1001 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = branchA_v2b.coder.ReduceMeanLayer1001(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = branchA_v2b.ReduceMeanLayer1001(cgInstance.Name);
    ...
    methods
        ...
        function [x_backbone_blocks_19] = predict(this, x_backbone_blocks_13__)
            ...
            x_backbone_blocks_13 = branchA_v2b.coder.ops.permuteInputVar(x_backbone_blocks_13_, [4 3 1 2], 4);
            ...
            x_backbone_blocks_19_ = branchA_v2b.coder.ops.permuteOutputVar(x_backbone_blocks_19__, [3 4 2 1], 4);
        ...
        function [x_backbone_blocks_19, x_backbone_blocks_19NumDims1005] = ReduceMeanGraph1003(this, x_backbone_blocks_13, x_backbone_blocks_13NumDims, Training)
            ...
            % ReduceMean:
            dims1002 = branchA_v2b.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1004, coder.const(x_backbone_blocks_13NumDims));
