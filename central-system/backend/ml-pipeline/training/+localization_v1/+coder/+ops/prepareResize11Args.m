...
%   Copyright 2024-2025 The MathWorks, Inc.  
    ...
    ONNXScales                        = localization_v1.coder.ops.extractIfDlarray(ONNXScales_);
    ONNXSizes                         = localization_v1.coder.ops.extractIfDlarray(ONNXSizes_);
    coordinate_transformation_mode    = localization_v1.coder.ops.extractIfDlarray(coordinate_transformation_mode_);
    mode                              = localization_v1.coder.ops.extractIfDlarray(mode_);
    nearest_mode                      = localization_v1.coder.ops.extractIfDlarray(nearest_mode_);
