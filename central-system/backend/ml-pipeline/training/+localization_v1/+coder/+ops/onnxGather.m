...
% Copyright 2024 The MathWorks, Inc.
    ...
    X          = localization_v1.coder.ops.extractIfDlarray(X_);
    ONNXIdx    = localization_v1.coder.ops.extractIfDlarray(ONNXIdx_);
    ONNXAxis   = localization_v1.coder.ops.extractIfDlarray(ONNXAxis_);
    numDimsX   = localization_v1.coder.ops.extractIfDlarray(numDimsX_);
    numDimsIdx = localization_v1.coder.ops.extractIfDlarray(numDimsIdx_);
