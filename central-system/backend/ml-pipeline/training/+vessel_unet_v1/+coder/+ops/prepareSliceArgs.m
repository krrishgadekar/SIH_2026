...
Starts = vessel_unet_v1.coder.ops.extractIfDlarray(Starts_);
Ends = vessel_unet_v1.coder.ops.extractIfDlarray(Ends_);
Axes_ = vessel_unet_v1.coder.ops.extractIfDlarray(Axes__);
Steps_ = vessel_unet_v1.coder.ops.extractIfDlarray(Steps__);
