      ...
      <svg ref={svgRef} viewBox="0 0 1000 1000" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <radialGradient id="retina-glow" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="var(--c-crimson)" stopOpacity="0.22" />
            <stop offset="50%" stopColor="var(--c-crimson)" stopOpacity="0.08" />
            <stop offset="100%" stopColor="var(--c-crimson)" stopOpacity="0" />
          </radialGradient>
        </defs>
        <circle cx="500" cy="500" r="450" fill="url(#retina-glow)" />
        ...
        <circle cx="300" cy="480" r="40" fill="none" stroke="var(--c-black)" opacity="0.5" strokeDasharray="4 4" />
